...
function useRemovePasswordTimeout(inputRef, triggerOnMount) {
  const removePasswordTimeoutRef = (0, import_react2.useRef)([]);
...
var Input = (0, import_react3.forwardRef)((props, ref) => {
  var _a;
  const {
    prefixCls: customizePrefixCls,
    bordered = true,
  ...
  const {
    ...
    direction,
    input
  } = import_react3.default.useContext(ConfigContext);
  ...
  const disabled = import_react3.default.useContext(DisabledContext_default);
  const mergedDisabled = customDisabled !== null && customDisabled !== void 0 ? customDisabled : disabled;
  const {
    status: contextStatus,
    hasFeedback,
    feedbackIcon
  } = (0, import_react3.useContext)(FormItemInputContext);
  const mergedStatus = getMergedStatus(contextStatus, customStatus);
  const inputHasPrefixSuffix = hasPrefixSuffix(props) || !!hasFeedback;
  const prevHasPrefixSuffix = (0, import_react3.useRef)(inputHasPrefixSuffix);
  if (true) {
  ...
  const suffixNode = (hasFeedback || suffix) && import_react3.default.createElement(import_react3.default.Fragment, null, suffix, hasFeedback && feedbackIcon);
  ...
  return wrapCSSVar(import_react3.default.createElement(es_default, Object.assign({
    ...
    className: (0, import_classnames2.default)(className, rootClassName, cssVarCls, rootCls, compactItemClassnames, input === null || input === void 0 ? void 0 : input.className),
    onChange: handleChange,
    addonAfter: addonAfter && import_react3.default.createElement(NoCompactStyle, null, import_react3.default.createElement(NoFormStyle, {
      override: true,
      status: true
    }, addonAfter)),
    addonBefore: addonBefore && import_react3.default.createElement(NoCompactStyle, null, import_react3.default.createElement(NoFormStyle, {
      override: true,
      status: true
    }, addonBefore)),
...
//# sourceMappingURL=chunk-B4DGFQZC.js.map
