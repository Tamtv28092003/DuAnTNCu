...
var InnerLoadingIcon = (0, import_react4.forwardRef)((props, ref) => {
  const {
    prefixCls,
    className,
    style,
  ...
  const mergedIconCls = (0, import_classnames5.default)(className, {
...
var InternalCompoundedButton = import_react5.default.forwardRef((props, ref) => {
  var _a, _b, _c;
  const {
    loading = false,
    prefixCls: customizePrefixCls,
  ...
  const needInserted = import_react5.Children.count(children) === 1 && !icon && !isUnBorderedButtonType(mergedType);
  ...
  const iconClasses = (0, import_classnames6.default)(customClassNames === null || customClassNames === void 0 ? void 0 : customClassNames.icon, (_b = button === null || button === void 0 ? void 0 : button.classNames) === null || _b === void 0 ? void 0 : _b.icon, {
  ...
  const genButtonContent = (iconComponent, kidsComponent) => iconPosition === "start" ? import_react5.default.createElement(import_react5.default.Fragment, null, iconComponent, kidsComponent) : import_react5.default.createElement(import_react5.default.Fragment, null, kidsComponent, iconComponent);
  ...
  let buttonNode = import_react5.default.createElement("button", Object.assign({}, rest, {
    ...
    ref: buttonRef
  }), genButtonContent(iconNode, kids), !!compactItemClassnames && import_react5.default.createElement(compactCmp_default, {
    key: "compact",
    prefixCls
  }));
...
//# sourceMappingURL=chunk-KATOSYDS.js.map
