...
var TransButton = React.forwardRef((props, ref) => {
  ...
  const {
    ...
    disabled,
    tabIndex = 0
  } = props, restProps = __rest(props, ["style", "noStyle", "disabled", "tabIndex"]);
  let mergedStyle = {};
  if (!noStyle) {
...
var InternalTooltip = React7.forwardRef((props, ref) => {
  var _a, _b;
  const {
    prefixCls: customizePrefixCls,
    openClassName,
  ...
  const child = React7.isValidElement(children) && !isFragment(children) ? children : React7.createElement("span", null, children);
...
var TextArea = (0, import_react4.forwardRef)((props, ref) => {
  ...
  return wrapCSSVar(React8.createElement(es_default3, Object.assign({
    ...
    className: (0, import_classnames5.default)(cssVarCls, rootCls, className, rootClassName, textArea === null || textArea === void 0 ? void 0 : textArea.className),
...
var useCopyClick = (_ref) => {
  ...
  const [copyLoading, setCopyLoading] = React10.useState(false);
  const copyIdRef = React10.useRef(null);
  const cleanCopyId = () => {
...
var useUpdatedEffect = (callback, conditions) => {
  const mountRef = React12.useRef(false);
  React12.useEffect(() => {
    if (mountRef.current) {
      callback();
    } else {
...
var Typography = React13.forwardRef((props, ref) => {
  const {
    prefixCls: customizePrefixCls,
  ...
  return wrapCSSVar(
    ...
    React13.createElement(Component, Object.assign({
...
var CopyBtn = (props) => {
  ...
  return React14.createElement(tooltip_default, {
    key: "copy",
    title: copyTitle
  }, React14.createElement(transButton_default, {
    ...
    "aria-label": ariaLabel,
    tabIndex
  }, copied ? getNode(iconNodes[1], React14.createElement(CheckOutlined_default, null), true) : getNode(iconNodes[0], btnLoading ? React14.createElement(LoadingOutlined_default, null) : React14.createElement(CopyOutlined_default, null), true)));
};
var CopyBtn_default = CopyBtn;

// node_modules/antd/es/typography/Base/Ellipsis.js
var React15 = __toESM(require_react());
var MeasureText = React15.forwardRef((_ref, ref) => {
  let {
    style,
    children
  } = _ref;
  const spanRef = React15.useRef(null);
...
function EllipsisMeasure(props) {
  ...
  const nodeList = React15.useMemo(() => toArray(text), [text]);
  const nodeLen = React15.useMemo(() => getNodesLen(nodeList), [text]);
  const fullContent = React15.useMemo(() => children(nodeList, false), [text]);
  const [ellipsisCutIndex, setEllipsisCutIndex] = React15.useState(null);
  const cutMidRef = React15.useRef(null);
  const needEllipsisRef = React15.useRef(null);
  const descRowsEllipsisRef = React15.useRef(null);
  const symbolRowEllipsisRef = React15.useRef(null);
  const [canEllipsis, setCanEllipsis] = React15.useState(false);
  const [needEllipsis, setNeedEllipsis] = React15.useState(STATUS_MEASURE_NONE);
  const [ellipsisHeight, setEllipsisHeight] = React15.useState(0);
  useLayoutEffect_default(() => {
  ...
  const finalContent = React15.useMemo(() => {
  ...
  return React15.createElement(React15.Fragment, null, finalContent, needEllipsis === STATUS_MEASURE_START && React15.createElement(React15.Fragment, null, React15.createElement(MeasureText, {
    style: Object.assign(Object.assign(Object.assign({}, measureStyle), lineClipStyle), {
      WebkitLineClamp: rows
    }),
    ref: needEllipsisRef
  }, fullContent), React15.createElement(MeasureText, {
    style: Object.assign(Object.assign(Object.assign({}, measureStyle), lineClipStyle), {
  ...
  }, children([], true))), needEllipsis === STATUS_MEASURE_NEED_ELLIPSIS && ellipsisCutIndex && ellipsisCutIndex[0] !== ellipsisCutIndex[1] && React15.createElement(MeasureText, {
...
var EllipsisTooltip = (_ref) => {
  ...
  return React16.createElement(tooltip_default, Object.assign({
...
function wrapperDecorations(_ref, content) {
  ...
  function wrap(tag, needed) {
    ...
    currentContent = React17.createElement(tag, {}, currentContent);
  }
  wrap("strong", strong);
  wrap("u", underline);
  wrap("del", del);
...
var ELLIPSIS_STR = "...";
var Base = React17.forwardRef((props, ref) => {
  var _a, _b, _c;
  const {
    prefixCls: customizePrefixCls,
    className,
  ...
  const typographyRef = React17.useRef(null);
  const editIconRef = React17.useRef(null);
  const prefixCls = getPrefixCls("typography", customizePrefixCls);
  ...
  const [isLineClampSupport, setIsLineClampSupport] = React17.useState(false);
  const [isTextOverflowSupport, setIsTextOverflowSupport] = React17.useState(false);
  const [isJsEllipsis, setIsJsEllipsis] = React17.useState(false);
  const [isNativeEllipsis, setIsNativeEllipsis] = React17.useState(false);
  const [isNativeVisible, setIsNativeVisible] = React17.useState(true);
  ...
  const needMeasureEllipsis = React17.useMemo(() => (
    // Disable ellipsis
  ...
  const [cssEllipsis, setCssEllipsis] = React17.useState(mergedEnableEllipsis);
  const canUseCssEllipsis = React17.useMemo(() => {
  ...
  const [ellipsisWidth, setEllipsisWidth] = React17.useState(0);
  ...
  } else if (React17.isValidElement(ellipsisConfig.tooltip)) {
    tooltipProps = {
  ...
  const topAriaLabel = React17.useMemo(() => {
  ...
  if (editing) {
    return React17.createElement(Editable_default, {
  ...
  const renderExpand = () => {
    ...
    return React17.createElement("a", {
      key: "expand",
  ...
  const renderEdit = () => {
    ...
    return triggerType.includes("icon") ? React17.createElement(tooltip_default, {
      key: "edit",
      title: tooltip === false ? "" : editTitle
    }, React17.createElement(transButton_default, {
      ref: editIconRef,
      className: `${prefixCls}-edit`,
      onClick: onEditClick,
      "aria-label": ariaLabel,
      tabIndex
    }, icon || React17.createElement(EditOutlined_default, {
      role: "button"
    }))) : null;
  };
  const renderCopy = () => {
    ...
    return React17.createElement(CopyBtn_default, Object.assign({
      key: "copy"
    }, copyConfig, {
      prefixCls,
      copied,
  ...
  const renderEllipsis = (canEllipsis) => [canEllipsis && !expanded && React17.createElement("span", {
    "aria-hidden": true,
    key: "ellipsis"
  ...
  return React17.createElement(es_default, {
  ...
  }, (resizeRef) => React17.createElement(EllipsisTooltip_default, {
    tooltipProps,
    enableEllipsis: mergedEnableEllipsis,
    isEllipsis: isMergedEllipsis
  }, React17.createElement(Typography_default, Object.assign({
    ...
    title
  }, textProps), React17.createElement(EllipsisMeasure, {
  ...
  }, (node, canEllipsis) => wrapperDecorations(props, React17.createElement(React17.Fragment, null, node.length > 0 && canEllipsis && !expanded && topAriaLabel ? React17.createElement("span", {
    key: "show-content",
    "aria-hidden": true
...
var Title = React18.forwardRef((props, ref) => {
  const {
    level = 1
  ...
  return React18.createElement(Base_default, Object.assign({
    ref
  }, restProps, {
    component
  }));
...
//# sourceMappingURL=chunk-J4RIEGUX.js.map
