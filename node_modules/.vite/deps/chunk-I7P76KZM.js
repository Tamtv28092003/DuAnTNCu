...
// node_modules/.pnpm/rc-util@5.38.1_react-dom@18.2.0_react@18.2.0/node_modules/rc-util/es/KeyCode.js
var KeyCode = {
  /**
   * MAC_ENTER
   */
...
var RESIZE_STABLE = 2;
var ResizableTextArea = React5.forwardRef(function(props, ref) {
  var _ref = props, prefixCls = _ref.prefixCls, onPressEnter = _ref.onPressEnter, defaultValue = _ref.defaultValue, value = _ref.value, autoSize = _ref.autoSize, onResize2 = _ref.onResize, className = _ref.className, style = _ref.style, disabled = _ref.disabled, onChange = _ref.onChange, onInternalAutoSize = _ref.onInternalAutoSize, restProps = _objectWithoutProperties(_ref, _excluded);
  ...
  var textareaRef = React5.useRef();
  React5.useImperativeHandle(ref, function() {
    return {
      textArea: textareaRef.current
    };
  });
  var _React$useMemo = React5.useMemo(function() {
  ...
  var _React$useState = React5.useState(RESIZE_STABLE), _React$useState2 = _slicedToArray(_React$useState, 2), resizeState = _React$useState2[0], setResizeState = _React$useState2[1];
  var _React$useState3 = React5.useState(), _React$useState4 = _slicedToArray(_React$useState3, 2), autoSizeStyle = _React$useState4[0], setAutoSizeStyle = _React$useState4[1];
  ...
  var resizeRafRef = React5.useRef();
  ...
  }, React5.createElement("textarea", _extends({}, restProps, {
    ref: textareaRef,
    style: mergedStyle,
...
// node_modules/.pnpm/rc-textarea@1.6.3_react-dom@18.2.0_react@18.2.0/node_modules/rc-textarea/es/TextArea.js
var _excluded2 = ["defaultValue", "value", "onFocus", "onBlur", "onChange", "allowClear", "maxLength", "onCompositionStart", "onCompositionEnd", "suffix", "prefixCls", "showCount", "count", "className", "style", "disabled", "hidden", "classNames", "styles", "onResize"];
var TextArea = import_react.default.forwardRef(function(_ref, ref) {
  var _countConfig$max, _clsx;
  var defaultValue = _ref.defaultValue, customValue = _ref.value, onFocus = _ref.onFocus, onBlur = _ref.onBlur, onChange = _ref.onChange, allowClear = _ref.allowClear, maxLength = _ref.maxLength, onCompositionStart = _ref.onCompositionStart, onCompositionEnd = _ref.onCompositionEnd, suffix = _ref.suffix, _ref$prefixCls = _ref.prefixCls, prefixCls = _ref$prefixCls === void 0 ? "rc-textarea" : _ref$prefixCls, showCount = _ref.showCount, count = _ref.count, className = _ref.className, style = _ref.style, disabled = _ref.disabled, hidden = _ref.hidden, classNames6 = _ref.classNames, styles = _ref.styles, onResize2 = _ref.onResize, rest = _objectWithoutProperties(_ref, _excluded2);
  var _useMergedState = useMergedState(defaultValue, {
    value: customValue,
    defaultValue
  }), _useMergedState2 = _slicedToArray(_useMergedState, 2), value = _useMergedState2[0], setValue = _useMergedState2[1];
  var formatValue = value === void 0 || value === null ? "" : String(value);
  var _React$useState = import_react.default.useState(false), _React$useState2 = _slicedToArray(_React$useState, 2), focused = _React$useState2[0], setFocused = _React$useState2[1];
  var compositionRef = import_react.default.useRef(false);
  var _React$useState3 = import_react.default.useState(null), _React$useState4 = _slicedToArray(_React$useState3, 2), textareaResized = _React$useState4[0], setTextareaResized = _React$useState4[1];
  ...
  var _React$useState5 = import_react.default.useState(null), _React$useState6 = _slicedToArray(_React$useState5, 2), selection = _React$useState6[0], setSelection = _React$useState6[1];
  ...
  if (countConfig.show) {
    ...
    suffixNode = import_react.default.createElement(import_react.default.Fragment, null, suffixNode, import_react.default.createElement("span", {
      className: (0, import_classnames2.default)("".concat(prefixCls, "-data-count"), classNames6 === null || classNames6 === void 0 ? void 0 : classNames6.count),
  ...
  return import_react.default.createElement(BaseInput_default, {
    value: formatValue,
    allowClear,
    handleReset,
    suffix: suffixNode,
    ...
    classNames: _objectSpread2(_objectSpread2({}, classNames6), {}, {
      affixWrapper: (0, import_classnames2.default)(classNames6 === null || classNames6 === void 0 ? void 0 : classNames6.affixWrapper, (_clsx = {}, _defineProperty(_clsx, "".concat(prefixCls, "-show-count"), showCount), _defineProperty(_clsx, "".concat(prefixCls, "-textarea-allow-clear"), allowClear), _clsx))
    }),
    disabled,
    focused,
    className: (0, import_classnames2.default)(className, isOutOfRange && "".concat(prefixCls, "-out-of-range")),
    ...
    hidden
  }, import_react.default.createElement(ResizableTextArea_default, _extends({}, rest, {
    maxLength,
    ...
    className: (0, import_classnames2.default)(classNames6 === null || classNames6 === void 0 ? void 0 : classNames6.textarea),
...
// node_modules/.pnpm/rc-textarea@1.6.3_react-dom@18.2.0_react@18.2.0/node_modules/rc-textarea/es/index.js
...
var OrderContext = React7.createContext(null);
...
function useDom(render, debug) {
  ...
  var appendedRef = React8.useRef(false);
  var queueCreate = React8.useContext(Context_default);
  var _React$useState3 = React8.useState(EMPTY_LIST), _React$useState4 = _slicedToArray(_React$useState3, 2), queue = _React$useState4[0], setQueue = _React$useState4[1];
...
var Portal = React10.forwardRef(function(props, ref) {
  ...
  var _React$useState = React10.useState(open), _React$useState2 = _slicedToArray(_React$useState, 2), shouldRender = _React$useState2[0], setShouldRender = _React$useState2[1];
  ...
  if (ref) {
    reffedChildren = React10.cloneElement(children, {
      ref: mergedRef
    });
  }
...
// node_modules/.pnpm/rc-util@5.38.1_react-dom@18.2.0_react@18.2.0/node_modules/rc-util/es/isMobile.js
...
var useId_default = useOriginId ? (
  ...
  function useCompatId(id) {
    var _React$useState = React11.useState("ssr-id"), _React$useState2 = _slicedToArray(_React$useState, 2), innerId = _React$useState2[0], setInnerId = _React$useState2[1];
...
function Mask(props) {
  ...
  return React13.createElement(es_default, _extends({}, motion, {
    motionAppear: true,
    visible: open,
    removeOnLeave: true
  }), function(_ref) {
...
var PopupContent = React14.memo(function(_ref) {
...
// node_modules/.pnpm/@rc-component+trigger@1.18.2_react-dom@18.2.0_react@18.2.0/node_modules/@rc-component/trigger/es/Popup/index.js
var Popup = React15.forwardRef(function(props, ref) {
  ...
  var _React$useState = React15.useState(!getPopupContainer || !getPopupContainerNeedParams), _React$useState2 = _slicedToArray(_React$useState, 2), show = _React$useState2[0], setShow = _React$useState2[1];
  useLayoutEffect_default(function() {
  ...
  return React15.createElement(Portal2, {
    open: forceRender || isNodeVisible,
    getContainer: getPopupContainer && function() {
      return getPopupContainer(target);
    },
    autoDestroy
  }, React15.createElement(Mask, {
    prefixCls,
    open,
    zIndex,
    mask,
    motion: maskMotion
  }), React15.createElement(es_default2, {
    onResize: onAlign,
    disabled: !open
  }, function(resizeObserverRef) {
    return React15.createElement(es_default, _extends({
      motionAppear: true,
      motionEnter: true,
      motionLeave: true,
      removeOnLeave: false,
      ...
      return React15.createElement("div", {
        ...
        onPointerEnter,
        onClick
      }, arrow && React15.createElement(Arrow, {
        prefixCls,
        arrow,
        arrowPos,
        align
      }), React15.createElement(PopupContent_default, {
        cache: !open && !fresh
      }, childNode));
    });
  }));
...
var TriggerWrapper = React16.forwardRef(function(props, ref) {
  var children = props.children, getTriggerDOMNode = props.getTriggerDOMNode;
  var canUseRef = supportRef(children);
  var setRef = React16.useCallback(function(node) {
    fillRef(ref, getTriggerDOMNode ? getTriggerDOMNode(node) : node);
  }, [getTriggerDOMNode]);
  var mergedRef = useComposeRef(setRef, children.ref);
  return canUseRef ? React16.cloneElement(children, {
    ref: mergedRef
  }) : children;
});
if (true) {
...
var TriggerContext = React17.createContext(null);
...
function useAlign(open, popupEle, target, placement, builtinPlacements, popupAlign, onPopupAlign) {
  ...
  var alignCountRef = React19.useRef(0);
  var scrollerList = React19.useMemo(function() {
    if (!popupEle) {
      return [];
    }
    return collectScroller(popupEle);
  }, [popupEle]);
  var prevFlipRef = React19.useRef({});
...
// node_modules/.pnpm/@rc-component+trigger@1.18.2_react-dom@18.2.0_react@18.2.0/node_modules/@rc-component/trigger/es/hooks/useWatch.js
...
function useWinClick(open, clickToHide, targetEle, popupEle, mask, maskClosable, inPopupOrChild, triggerOpen) {
  var openRef = React20.useRef(open);
  var lockRef = React20.useRef(false);
...
function generateTrigger() {
  ...
  var Trigger = React21.forwardRef(function(props, ref) {
    ...
    var _React$useState = React21.useState(false), _React$useState2 = _slicedToArray(_React$useState, 2), mobile = _React$useState2[0], setMobile = _React$useState2[1];
    useLayoutEffect_default(function() {
      setMobile(isMobile_default());
    }, []);
    var subPopupElements = React21.useRef({});
    var parentContext = React21.useContext(context_default);
    ...
    var _React$useState3 = React21.useState(null), _React$useState4 = _slicedToArray(_React$useState3, 2), popupEle = _React$useState4[0], setPopupEle = _React$useState4[1];
    ...
    var _React$useState5 = React21.useState(null), _React$useState6 = _slicedToArray(_React$useState5, 2), targetEle = _React$useState6[0], setTargetEle = _React$useState6[1];
    var externalForwardRef = React21.useRef(null);
    ...
    var _React$useState7 = React21.useState(defaultPopupVisible || false), _React$useState8 = _slicedToArray(_React$useState7, 2), internalOpen = _React$useState8[0], setInternalOpen = _React$useState8[1];
    ...
    var openRef = React21.useRef(mergedOpen);
    openRef.current = mergedOpen;
    var lastTriggerRef = React21.useRef([]);
    ...
    var _React$useState9 = React21.useState(false), _React$useState10 = _slicedToArray(_React$useState9, 2), inMotion = _React$useState10[0], setInMotion = _React$useState10[1];
    useLayoutEffect_default(function(firstMount) {
      if (!firstMount || mergedOpen) {
        setInMotion(true);
      }
    }, [mergedOpen]);
    var _React$useState11 = React21.useState(null), _React$useState12 = _slicedToArray(_React$useState11, 2), motionPrepareResolve = _React$useState12[0], setMotionPrepareResolve = _React$useState12[1];
    var _React$useState13 = React21.useState([0, 0]), _React$useState14 = _slicedToArray(_React$useState13, 2), mousePos = _React$useState14[0], setMousePos = _React$useState14[1];
    ...
    var alignedClassName = React21.useMemo(function() {
    ...
    var _React$useState15 = React21.useState(0), _React$useState16 = _slicedToArray(_React$useState15, 2), targetWidth = _React$useState16[0], setTargetWidth = _React$useState16[1];
    var _React$useState17 = React21.useState(0), _React$useState18 = _slicedToArray(_React$useState17, 2), targetHeight = _React$useState18[0], setTargetHeight = _React$useState18[1];
    ...
    var triggerNode = React21.cloneElement(child, _objectSpread2(_objectSpread2({}, mergedChildrenProps), passedProps));
    var arrowPos = {
      x: arrowX,
      y: arrowY
    };
    var innerArrow = arrow ? _objectSpread2({}, arrow !== true ? arrow : {}) : null;
    return React21.createElement(React21.Fragment, null, React21.createElement(es_default2, {
      disabled: !mergedOpen,
      ref: setTargetRef,
      onResize: onTargetResize
    }, React21.createElement(TriggerWrapper_default, {
      getTriggerDOMNode
    }, triggerNode)), React21.createElement(context_default.Provider, {
      value: context
    }, React21.createElement(Popup_default, {
...
//# sourceMappingURL=chunk-I7P76KZM.js.map
